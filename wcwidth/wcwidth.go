// wcwidth is a Go implementation of wcwidth(3).
//
// This is ported from src.elv.sh/pkg/wcwidth, which is in turn ported from
...
// RuneWidth returns the column width of a rune.
