...
// WriteNotifyWorkingDirectory writes a sequence that notifies the terminal of
// the current working directory to the given writer.
//
//	OSC 7 ; Pt BEL
//
...
func WriteNotifyWorkingDirectory(w io.Writer, host string, paths ...string) (int, error) {
	...
	return io.WriteString(w, "\x1b]7;"+u.String()+"\x07")
}
